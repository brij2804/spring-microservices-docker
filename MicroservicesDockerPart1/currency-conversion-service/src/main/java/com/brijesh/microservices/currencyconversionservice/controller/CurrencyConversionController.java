...
public class CurrencyConversionController {
    ...
    @GetMapping("/currency-conversion-static/from/{from}/to/{to}/quantity/{quantity}")
    ...
    public CurrencyConversion calculateCurrencyConversionDynamic(@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity){
        ...
        return new CurrencyConversion(currencyConversion.getId(),from,to,currencyConversion.getConversionMultiple(),quantity ,quantity.multiply(currencyConversion.getConversionMultiple()),currencyConversion.getEnvironment()+" "+"resttemplate");
    }
